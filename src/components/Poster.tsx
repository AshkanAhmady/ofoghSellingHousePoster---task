...
const Poster: React.FC<any> = ({ poster }) => {
    ...
    return (
        <div className="w-[400px] bg-white border border-gray-200 rounded-lg shadow duration-150 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-5 h-full flex flex-col justify-between">
                <h5 className="mb-2 text-xl tracking-tight text-stone-900 duration-150 dark:text-white">{poster.address}</h5>
